...
### Добавлено
- **Основа (README, BRAIN_CONTRACT):** в README добавлена секция «Основа (Foundations)» со ссылками на [теорию SIFS](https://github.com/m0rfy/SIFS-Theory-Core) и [genesis-agi](https://github.com/H4V1K-dev/genesis-agi); блок «Репозитории и сверка SIFS» расширен явными URL обоих репо. В BRAIN_CONTRACT — строка «Основа» с теми же ссылками.
