...
Этот репозиторий — каноническое дерево **SIFS-Genesis** (CPU-мозг). **Genesis-AGI — отдельный независимый проект** ([H4V1K-dev/genesis-agi](https://github.com/H4V1K-dev/genesis-agi)); мы не его авторы. Мы взяли у них разработки Genesis и соединили с **нашей теорией SIFS** — так получился этот проект. Движок Genesis подключается как submodule (копия для SIFS). **Связанный репо:** [m0rfy/genesis-agi-sifs](https://github.com/m0rfy/genesis-agi-sifs) — наша копия движка для push; sifs-genesis-brain и genesis-agi-sifs рассматриваются совместно. Клонируйте и собирайте отсюда.
